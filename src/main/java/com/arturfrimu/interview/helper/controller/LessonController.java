...
public class LessonController {
    ...
    @GetMapping
    public ResponseEntity<List<LessonInfoResponse>> list() {
        var lessons = lessonService.list();
        return ok(lessons);
    }

    @GetMapping("/{id}")
    public ResponseEntity<LessonInfoResponse> find(@PathVariable Long id) {
        var lesson = lessonService.find(id);
        return ok(lesson);
    }

    @PostMapping
    public ResponseEntity<LessonInfoResponse> create(@RequestBody CreateLessonRequest body) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<LessonInfoResponse> update(@PathVariable Long id, @RequestBody UpdateLessonRequest body) {
